...
# Spot DL enabled
spotdl_enabled = os.environ.get('SPOTDL_ENABLED', None)
if spotdl_enabled != 'ON':
    spotdl_enabled = None

utils.logger.info(f'SPOTDL_ENABLED: {spotdl_enabled}')
...
def init_distributed(dist_backend="nccl",
    ...
    if dist_init_required is False:
        ...
        if cdb is not None and cdb.is_initialized():
            ...
            cdb = TorchBackend(dist_backend, timeout, init_method, rank=rank, world_size=world_size, store=store)

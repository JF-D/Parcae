...
def parse_args(extra_args_provider=None, defaults={},
    ...
    if os.environ.get('NSYS_PROF', None):
        args.num_workers = 0
    ...
    if os.environ.get('SPOTDL_ENABLED', 'OFF') == 'ON':
        args.pipe_parallel_size = int(os.environ.get('SPOTDL_NUM_STAGES', 1))
    if args.rank == 0:
        print('using world size: {} and model-parallel size: {} (SPOTDL: {}) '.format(
            args.world_size, args.model_parallel_size, os.environ.get('SPOTDL_ENABLED', 'OFF')))
...
def _add_data_args(parser):
    ...
    group.add_argument('--data-impl', type=str, default='infer',
                       choices=['lazy', 'cached', 'mmap', 'infer', 'synthetic', 'wikitext'],
